...
REFERENCE_POLYMER_CSV = CONFIG_DIR / "polymers" / "polymer_library_v2.csv"
...
def run_screening(
    ...
    return {
        ...
        "pca_retained_k": pca_result.n_components_retained,
        ...
        "uq_converged": uq_result.converged,
        "oat_top1_stable": oat_res.is_top1_robust,
        ...
        "baseline_outperforms": val_report.baseline_result.outperforms_baselines,
